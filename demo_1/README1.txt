...
1. SSH into the remote server using a Linux/Unix based terminal
   1. Type ssh [your netid]@coewww.rutgers.edu and hit enter
      1. Type ‘yes’ when asked if you want to continue
      2. Enter you engineering username and password
2. Viewing website and website code
   1. Cd into /www/custom/zippypark/ZippyPark
   2. Type node server.js
      1. You may get an error if express is not already installed
   3. Go to zippypark.rutgers.edu and view the website
   4. Pages can be navigated to using the sidebars
-------------------------------------------------------------------------------------------------------------------------------
