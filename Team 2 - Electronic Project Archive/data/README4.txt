...
Although there are no scripts to run for data collection purposes, one can see that the manager website is 
...
README4.TXT - DATABASE FILES

As instructed, the database MySQL files are included in this folder.
